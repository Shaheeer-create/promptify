...
""",
    ...
    while True:
        ...
        result = Runner.run_streamed(Responder, input=user_input, session=session)
        full_output = ""
        ...
        print("\n")
        store_in_supabase("user_123", user_input, full_output.strip())
